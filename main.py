...
affine_registration_params['model_path'] = # TO DEFINE "/path/to/outdoor.ckpt" (MegaDepth/ScanNet checkpoint path)
affine_registration_params['main_config_path']= "./networks/feature_matching/configs/loftr/outdoor/loftr_ds_quadtree.py"
